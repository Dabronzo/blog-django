# Generated by Django 3.2 on 2022-02-16 11:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(auto_now_add=True)),
                ('approved', models.IntegerField(choices=[(0, 'Draft'), (1, 'Post')], default=0)),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='post_coment', to='blog.post')),
            ],
            options={
                'ordering': ['created_on'],
            },
